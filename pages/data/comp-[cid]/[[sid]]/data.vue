            ...
            <div class="nav-wrapper">
                <div class="table-head">
                    <div class="tabs">
                        ...
                        <NuxtLink class="tab active" :to="'/data/comp-' + route.params.cid + '/' + route.params.sid + '/data'">
                            数据
                        </NuxtLink>
                        <NuxtLink class="tab" :to="'/data/comp-' + route.params.cid + '/' + route.params.sid + '/analyze'">
                            分析
                        </NuxtLink>
                    </div>
                </div>
